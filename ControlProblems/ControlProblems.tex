\chapter{A very brief introduction to control problems} 
	...
	What seems promising at the first glance, is quite unsatisfactory, as \say{[the dynamic programming equation] is very difficult to handle, since the operation involved on the right-hand side [...] is too complicated.}, Zhou and Yong confirm in \cite[p. ~160]{zhou}.
