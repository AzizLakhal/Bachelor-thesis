...
\Panzahl    {3}                   %% number of authors (up to 5 authors supp.)
...
\Pjahr      {2021}               %% year of publ.

\Pdatum     {\today}             %% date of submission to journal, default: today 

\Pcoautor   {Prof. Dr. Christian Bender}   %% name of 2nd author 
\Pcoanschrift {Saarland University \\ Department of Mathematics \\
	P.O. Box 15 11 50   \\ 66041 Saarbr\"ucken \\
	Germany}
\Pcoepost   {bender@math.uni-sb.de}     %% email  of 2nd author



%%--<>------------- 3rd AUTHOR --------------
\qPautor     {Prof. Dr. Martin Fuchs}     %% name of 3rd author
\qPanschrift { Saarland University\\  Department of Mathematics\\
	P.O. Box 15 11 50 \\  66041 Saarbr\"ucken\\
	Germany}
\qPepost     {fuchs@math.uni-sb.de}   %% email of 3rd author
...
\includepdf[pages=-]{./Selbstaendigkeitserklaerung_signed.pdf}

\includepdf[pages=-]{./Uebereinstimmung_signed.pdf}
